...
# ------------------------------------------------------------------
    try:
        ...
        while True:
            ...
            print("Request sent to Bio Sensor")


            data = sensor_socket.recv(4096)

            if not data:
                print("Bio Sensor disconnected.")
                break
